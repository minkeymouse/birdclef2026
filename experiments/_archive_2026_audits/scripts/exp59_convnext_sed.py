#!/usr/bin/env python3
"""exp59 — ConvNeXt-tiny SED with same 2025-BG mixing recipe as exp50.

Goal: architecture-diverse third teacher. Different inductive bias from
HGNet → low residual correlation with exp50, blend gain potential.

Recipe identical to exp50, only backbone changed:
...
OUT = ROOT / "experiments" / "exp59_outputs"
...
BATCH_SIZE = 24; EPOCHS = 18; LR = 8e-4; WD = 1e-2
NUM_WORKERS = 4
