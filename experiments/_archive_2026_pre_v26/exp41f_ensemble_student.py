...
Output:
  experiments/exp41f_outputs/best_ckpt.pt
  experiments/exp41f_outputs/val_scores.npz (Val-A 59 files)
"""
...
OUT = ROOT / "experiments" / "exp41f_outputs"
...
def main():
    ...
    # Pseudo
    pseudo_df = pd.read_parquet(EXP41 / "pseudo_ensemble_df.parquet")
    pseudo_labels = np.load(EXP41 / "pseudo_ensemble_labels.npz")["labels"]
