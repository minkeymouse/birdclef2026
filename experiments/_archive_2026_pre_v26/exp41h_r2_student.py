...
Output:
  experiments/exp41h_outputs/best_ckpt.pt
  experiments/exp41h_outputs/val_scores.npz (Val-A 59 files)
"""
...
OUT = ROOT / "experiments" / "exp41h_outputs"
...
def main():
    ...
    # Pseudo
    pseudo_df = pd.read_parquet(EXP41 / "pseudo_r2_df.parquet")
    pseudo_labels = np.load(EXP41 / "pseudo_r2_labels.npz")["labels"]
