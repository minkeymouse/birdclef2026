...
Output:
  experiments/exp35_outputs/best_ckpt.pt  — best epoch weights
  experiments/exp35_outputs/val_scores.npz — (708, 234) Val-A logits
  experiments/exp35_outputs/results.json  — per-epoch metrics
"""
...
OUT = ROOT / "experiments" / "exp35_outputs"
...
BACKBONE = "convnextv2_tiny.fcmae_ft_in22k_in1k"  # pretrained
N_CLASSES = 234
