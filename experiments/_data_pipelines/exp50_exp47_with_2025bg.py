#!/usr/bin/env python3
"""exp50 — Retrain exp47 SED with 2025 soundscapes as background mix source.
...
Solution: mix with RANDOM 2025 soundscape quiet windows (Colombia geography,
unrelated species distribution) to force site-invariant feature learning.
...
Output: experiments/exp50_outputs/
...
OUT = ROOT / "experiments" / "exp50_outputs"
