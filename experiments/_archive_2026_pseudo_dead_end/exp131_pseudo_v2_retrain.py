#!/usr/bin/env python3
"""exp131 — SED retrain with v2 verified pseudo as additional training data.
...
PSEUDO_REFINED_CSV = DATA / "pseudo_soundscapes_labels_verified_v2.csv"
OUT = ROOT / "experiments/_data_pipelines/exp131_outputs"
...
def main():
    print("=== exp129: SED retrain with refined pseudo-labels ===\n", flush=True)
    set_seed(SEED)
